                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <select name="projects_dimension" class="form-control">
                                    ...
                                    <option <?= $projeto->projects_dimension == 'col-md-6' ? 'selected' : '' ?> value="col-md-6">Grande</option>
                                    <option <?= $projeto->projects_dimension == 'col-md-4' ? 'selected' : '' ?> value="col-md-4">Média</option>
                                </select>
                            </div>
                        </div>
                    </div>
