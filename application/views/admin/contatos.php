                    ...
                    <div class="list-group">
                        <?php foreach ($contatos as $contato) { ?>
                            <div class="list-group-item">
                                <div class="row">
                                    <div class="col-lg-10">
                                        <h4 class="list-group-item-heading"><?= $contato->contato_nome ?> | <?= $contato->contato_email ?></h4>
                                    ...
                                    <div class="col-lg-2 text-center">
                                        ...
                                        <a style="font-size: 32px; margin-right: 10px;" href="<?= base_url('admin/delete-contato/') . $contato->contato_id ?>" class="hint--top hint--info" aria-label="Apagar contato"><i class="fa fa-trash"></i></a>
