...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <?= form_open_multipart(base_url('admin/editar-parceiro/') . $parceiro->partners_id, array("method" => "POST")); ?>
            <div class="col-lg-8">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input name="partners_contact" type="text" 
                                   value="<?= $parceiro->partners_contact ?>"
            ...
            <div class="col-lg-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <input id="partners_avatar" type="file" name="partners_avatar" value="<?= $parceiro->partners_avatar ?>" class="input-file" data-show-preview="false">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input name="partners_active" <?= $parceiro->partners_active == 1 ? 'checked' : '' ?> type="checkbox">Mostrar parceiro?
                                    </label>
                                </div>
                            </div>
                        </div>
